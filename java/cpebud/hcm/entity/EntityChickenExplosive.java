...
public class EntityChickenExplosive extends EntityChickenBase
{
	...
	//Creeper Effects
    private static final DataParameter<Integer> STATE = EntityDataManager.<Integer>createKey(EntityChickenExplosive.class, DataSerializers.VARINT);
    private static final DataParameter<Boolean> IGNITED = EntityDataManager.<Boolean>createKey(EntityChickenExplosive.class, DataSerializers.BOOLEAN);
    /**
