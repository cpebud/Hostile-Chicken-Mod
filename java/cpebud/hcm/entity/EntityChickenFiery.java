...
public class EntityChickenFiery extends EntityChickenBase
{
	public EntityChickenFiery(World worldIn)
	{
		...
		//FieryChicken likes fire and avoids water
	...
	//Blaze Effects
    private static final DataParameter<Byte> ON_FIRE = EntityDataManager.<Byte>createKey(EntityChickenFiery.class, DataSerializers.BYTE);

    protected void initEntityAI()
    {
        this.tasks.addTask(4, new EntityChickenFiery.AIFireballAttack(this));
    ...
    static class AIFireballAttack extends EntityAIBase
        {
            private final EntityChickenFiery blaze;
            private int attackStep;
            private int attackTime;

            public AIFireballAttack(EntityChickenFiery blazeIn)
            {
                this.blaze = blazeIn;
                this.setMutexBits(3);
            }
